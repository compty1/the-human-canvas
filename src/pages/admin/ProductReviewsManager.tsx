      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/admin/product-reviews/new"><PopButton><Plus className="w-4 h-4 mr-2" /> New Review</PopButton></Link>
          </div>
        </div>
        ...
        {isLoading ? (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <div className="flex flex-wrap gap-4 mt-3 text-xs text-muted-foreground">
                      {review.pain_points && review.pain_points.length > 0 && (<span>{review.pain_points.length} pain points</span>)}
                      {review.improvement_suggestions && review.improvement_suggestions.length > 0 && (<span>{review.improvement_suggestions.length} suggestions</span>)}
          ...
          <ComicPanel className="p-12 text-center">
            ...
            <Link to="/admin/product-reviews/new"><PopButton><Plus className="w-4 h-4 mr-2" /> Create Your First Review</PopButton></Link>
          </ComicPanel>
        )}

        <BulkActionsBar selectedIds={selectedIds} onClearSelection={clearSelection} tableName="product_reviews" queryKey={["admin-product-reviews"]} actions={["publish", "unpublish", "delete"]} statusField="published" />
      </div>
